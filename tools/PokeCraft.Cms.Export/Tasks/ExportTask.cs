...
namespace PokeCraft.Cms.Export.Tasks;

internal abstract class ExportTask : ICommand
{
  /// <summary>
  ...
  protected ExportTask(string? description = null, string? nameOverride = null, Guid? id = null, DateTime? startedOn = null)
  {
    Id = id ?? Guid.NewGuid();
  ...
  public override bool Equals(object? obj) => obj is ExportTask task && task.GetType().Equals(GetType()) && task.Id == Id;
