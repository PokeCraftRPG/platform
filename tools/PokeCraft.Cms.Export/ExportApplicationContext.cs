...
internal class ExportApplicationContext : IApplicationContext
{
  private readonly ICacheService _cacheService;

  public ExportApplicationContext(ICacheService cacheService)
  {
  ...
  public string BaseUrl { get; set; } = "export";
